...
def load_model():
    ...
    scrappedReviews = pd.read_csv('data_set/scrappedReviews.csv')
    ...
    colors = ['#41fc1c','red']
    plt.pie(sentiments,explode=explode,startangle=90,colors=colors, labels = langs,autopct='%1.2f%%')
    cwd = os.getcwd()
...
def main():
    print("Sentiment Analysis will start soon ")
    load_model()
    open_browser()
    #update_app_ui()
    ...
    print("Sentiment Analysis Project have started")
    project_name = None
